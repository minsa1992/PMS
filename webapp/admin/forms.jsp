...
<head>
    ...
    <title>Hanil Networks(admin)수정</title>
...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="margin-left: 1%">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form name="createuser" action='../user/createuser.do' method='POST'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="division_code">
                                                ...
                                                <option value=1>SM사업부</option>
                                                <option value=2>SS사업부</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>직급</label>
                                        ...
                                        <button type="submit" onclick="return usercheck(this.form)"class="btn btn-default">등록</button>
    ...
    <script>
    	function usercheck(frm){
    		var usercheck = "회원 등록 하시겠습니까?"
    		
    		if(confirm(usercheck)){
    			return true;
    		}else{
    			return false;	
    		}
