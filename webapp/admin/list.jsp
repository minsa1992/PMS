...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link rel="stylesheet" href="../vendor/metisMenu/metisMenu.min.css" type="text/css">

    <!-- DataTables CSS -->
    <link rel="stylesheet" href="../vendor/datatables-plugins/dataTables.bootstrap.css" type="text/css">

    <!-- DataTables Responsive CSS -->
    <link rel="stylesheet" href="../vendor/datatables-responsive/dataTables.responsive.css" type="text/css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="../dist/css/sb-admin-2.css" type="text/css">

    <!-- Custom Fonts -->
    <link  rel="stylesheet" type="text/css" href="../vendor/font-awesome/css/font-awesome.min.css" type="text/css">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="./list.do"><i class="fa fa-table fa-fw"></i> 물품 리스트</a>
                        </li>
                        <li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var='dto' items="${list }">
										<tr>
											<td>${dto.category }</td>
											<td><a href="./read.do?product_id=${dto.product_id }">${dto.product_name }</a></td>
											<td>${dto.product_location }</td>
											<td class="center">${dto.stock }</td>
											<td>${dto.user_id }</td>
										</tr>
									</c:forEach>
                                </tbody>
